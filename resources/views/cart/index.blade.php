...
<div class="cart-wrap">
	...
	<!-- Modal -->
	<div class="modal fade" id="presencial" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Recogo en tienda</h5>
		...
		<div class="modal-body">
			<form>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="doc_cargo" value="">
				</div>
				<div class="form-group">
					<label for="cargo" class="col-form-label">Recogido por:</label>
					<input type="text" class="form-control" id="cargo" value="">
				</div>
				<div class="form-group">
					<label for="phone_cargo" class="col-form-label">Telefono:</label>
					<input type="text" class="form-control" id="phone_cargo" value="">
				</div>
			</form>
		</div>
		<div class="modal-footer">
			<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
			<button id="savePresencial" type="button" class="btn btn-primary">Guardar</button>
		</div>
		</div>
	</div>
	</div>
			...
			<div class="modal-body">
				<form>
					...
					<div class="form-group">
						...
						<input type="number" maxlength="9" class="form-control" id="phone" value="">
					</div>
					<div class="form-group">
						<label for="message-text" class="col-form-label">Dirección:</label>
						<input type="text" class="form-control" id="ship_address" value="" maxlength="255">
					</div>
					<div class="form-group">
