    ...
    <div id="upLoad" class="dropzone" action="/upload/images/products" method="post" enctype="multipart/form-data">
        ...
        <div id="{{$i->asset_id}}" class="dz-preview dz-processing dz-image-preview dz-complete">
            ...
            <div class="dz-details">
                <div class="dz-size">
                    <span data-dz-size=""><strong>64.2</strong> KB</span>
                </div>
                <div class="dz-filename"><span data-dz-name="">{{$i->asset_id}}</span></div>
            </div>
...
<!-- Imagenes -->
<div class="form-group col-sm-12" id="contentImages"></div>
